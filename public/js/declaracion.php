<?php
    include "auth/ASEngine/AS.php";

    if (!app('login')->isLoggedIn() ) {
        header("Location: http://gtrgestion.cl/auth/logout");
		//redirect('login.php');
    }
...
//-------------Verificar que no se pasen x dias-----------------------

//	$now = new DateTime();
//	$date1=date_create($currentUser->reset_date);
//	$date2=date_create($now->format('Y-m-d'));
//	$diff=date_diff($date1,$date2);
//
//	if($currentUser->reset_dia !=0){
//		if(intval($diff->format("%a")) > $currentUser->reset_dia ){
//			redirect("profile_change_pass.php");
//		}
//	}
...
//--------------------------------------------------------------------
	...
	if($currentUser->id == 235 || $currentUser->id == 88 || $currentUser->id == 81 || $currentUser->id == 78 || $currentUser->id == 1
	|| $currentUser->id == 275
	//Camanchaca
	|| $currentUser->id == 266 || $currentUser->id == 83 || $currentUser->id == 583 || $currentUser->id == 110 || $currentUser->id == 82
	//Australis
	|| $currentUser->id == 138 || $currentUser->id == 409 || $currentUser->id == 137 || $currentUser->id == 390 || $currentUser->id == 562
	|| $currentUser->id == 582
	//Blumar
	|| $currentUser->id == 224
	|| $currentUser->id == 321
	...
	|| $currentUser->id == 333
	//Yadran
	|| $currentUser->id == 345 || $currentUser->id == 348 || $currentUser->id == 351 || $currentUser->id == 352
	//MOWI
	|| $currentUser->id == 80 || $currentUser->id == 55
	//Ventisqueros
	|| $currentUser->id == 423 || $currentUser->id == 425 || $currentUser->id == 468 || $currentUser->id == 604 || $currentUser->id == 605
	//Austral
	|| $currentUser->id == 490 || $currentUser->id == 491 || $currentUser->id == 492
	//Antartica
	|| $currentUser->id == 520 || $currentUser->id == 543 || $currentUser->id == 544
  //Si es administrador
  || $currentUser->role == "admin_fan_empresa"
	){

    }else{redirect('../intro_editor.php');}
...
<head>
    ...
    <title>Gestión Reportes Florecimiento Algas Nocivas</title>  <!--agregarlo o dejar el titulo del header (como lo hace el motor de busqueda)-->
    <link href="css/bootstrap.css" rel="stylesheet">
    <link href="css/metisMenu.css" rel="stylesheet">
    <link href="css/timeline.css" rel="stylesheet">
    <?php   include "sb-admin-css.php"; ?>
    ...
    <link rel="icon" type="image/x-icon" href='GtrFan-MonitoreoAlgasNocivas_symbol.png' />
    ...
    <script src="js/chartjs/chartjs-plugin-datalabels/chartjs-plugin-datalabels.js"></script>
	...
	<div id="wrapper">
      ...
      <?php include "menu_editor.php"; ?>
       	...
       	<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="row pull-right" style="margin-right:20px;position: fixed;right: 0px;">
                        ...
                        <button id="btn_descarga" class="btn btn-default pull-right hidden" onclick="exportar_sernapesca();" title="Exportar planilla Semanal Sernapesca" style="margin-top:10px;">Sernapesca</button>
                    </div>
                          ...
                          <div class="tab-content" style="margin-top: 25px;">
                            ...
                            <div id="menu2" class="tab-pane fade">
                              	...
                              	<div class="list-group" id="tareas_lista2" style="margin-top:10px;">
									<div class="graficos1e" style="margin-left: -62px;margin-right:  -175px;     ">
                                        <div class="col-lg-11 col-md-11 col-xs-11" style="padding: 20px; padding-top:0px; width:100%; margin-bottom:25px; margin-top:25px;">
                                            ...
                                            <canvas class="" id="chart-bar2" height="150" width="550"></canvas>
                                        </div>
                        ...
                        <div class="panel-body" >
                            ...
                            <div class="row" style=" margin-top:10px; margin-left:110px; margin-right:110px;">
                                <div class="dataTable_wrapper" id="hidediato">
                                    ...
                                    <table cellSpacing="0" data-toggle="table"  data-url="" data-pagination="false" data-side-pagination="client" data-cache="false" width="100%" class="table table-striped table-bordered table-hover letrachica table2"   id="tabladiatomeasverprint" >
                                        <thead>
                                            <tr>
                                ...
                                <div class="dataTable_wrapper" id="hidedino" style="margin-top:15px;" >
                                    <h6 class="text-center"> DINOFLAGELADOS </h6>
                                        <table cellSpacing="0" data-toggle="table"  data-url="" data-pagination="false" data-side-pagination="client" data-cache="false" width="100%" class="table table-striped table-bordered table-hover letrachica table2"   id="tabladinoflageladosverprint" >
                                            <thead>
                                                <tr>
                                                    <th data-formatter="runningFormatterreporte" data-align= "center" data-valign = "middle" data-width = "35px">#</th>
                                                    <!--<th data-formatter="runningFormatterfoto" data-align= "center" data-valign = "middle" data-width = "60px">Imagen</th>-->
                                ...
                                <div class="dataTable_wrapper" id="hideoesp" style="margin-top:15px;">
                                    ...
                                    <table cellSpacing="0" data-toggle="table"  data-url=""  data-pagination="false" data-side-pagination="client" data-cache="false" width="100%" class="table table-striped table-bordered table-hover letrachica table2"   id="tablaoespeciesverprint" >
                                        <thead>
                                            <tr>
                                                <th data-formatter="runningFormatterreporte" data-align= "center" data-valign = "middle" data-width = "35px">#</th>
                                               <!-- <th data-formatter="runningFormatterfoto" data-align= "center" data-valign = "middle" data-width = "60px">Imagen</th>-->
                                ...
                                <div class="dataTable_wrapper hidden" style="margin-top:15px;">
                                    <h6 class="text-center"> PARÁMETROS AMBIENTALES </h6>
                                    <table cellSpacing="0" data-toggle="table"  data-url=""  data-pagination="false" data-side-pagination="client" data-cache="false" width="100%" class="table table-striped table-bordered table-hover letrachica table2"   id="tablapambientalesverprint" style="table-layout: fixed;">
                                        <thead>
                                            <tr>
                                ...
                                <div class="dataTable_wrapper hidden" style="margin-top:10px;">
                                    <table cellSpacing="0" data-toggle="table"  data-url="" data-pagination="false" data-side-pagination="client" data-cache="false" width="100%" class="table table-striped table-bordered table-hover letrachica table2"   id="tablapambientalesotrosverprint" style="table-layout: fixed;">
                                        <thead>
                                            <tr>
                            ...
                            <div id="footerprint" class="modal-footer text-center" style="margin-top: 20px;" >
                                <div class="text-center" style="font-size:12px; margin-top:5px; margin-bottom: -15px;margin-left:110px;margin-right:75px;">
                                    ...
                                    <div class="nombreusuariodeclarar" style="display: inline;"></div> <br/><br/>
...
$('#obsarea').each(function () {
	...
	function savehistorial(){
		...
		$.ajax({
				...
				type: 'post',
				data: {
				 Modificacion:	 "Estado Declaración",
				 Observaciones: 	estado,
				 user_id:		  user_id
				},
				success: function(msg)
				{
					alert("Estado de "+estado+" guardaro.");
...
function savehistorial(){
  var obs = "PLanilla Semanal Sernapesca datos desde "+document.getElementById("datetimepicker_filtro_excel1").value+" hasta "+document.getElementById("datetimepicker_filtro_excel2").value;
  $.ajax({
      url: "save_historial_descargas.php",
      type: 'post',
      data: {
       Modificacion:	 "Descarga Reporte Semanal Sernapesca",
       Observaciones: 	obs,
       user_id:		  user_id
      },
      success: function(msg)

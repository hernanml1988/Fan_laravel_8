	...
	<script>
	  ...
	  function cargarexcelautomatico(form_data,file_name){
			if(file_name){
				...
				form_data.append('select_file', $('#cargarexcel')[0].files[0]);
				form_data.append('user_id', user_id);
...
// 						if(estadoaux =='Si')
// 							{ 
// 								$('#guardaredit').addClass("hidden"); 
// 							}else
// 							{ 
// 								$('#guardaredit').removeClass("hidden");
// 							}
// 						samegrupo2 = 0;
// 						res2 = 0;
// 						n2 = 0;
...
// 						$('#myModaleditreporte').modal('show');
// 				  	}else{ 
// 						swal("", "No se puede editar un registro declarado", "warning");
// 						}
// 			  	}else{ 
// 					swal("", "Sólo se puede editar un registro guardado (no enviado)", "warning");
// 					}		  		
//   	};
